...
<!--    </div>-->
    <el-table v-loading="$store.state.app.loading" :data="dataList" @selection-change="handleSelectionChange">
      ...
      <el-table-column
        ...
        :show-overflow-tooltip="true"
      />
      <el-table-column label="短视频" align="center" prop="createdAt" width="200">
        <template slot-scope="scope">
          <video controls width="100" autoplay="false" :src="baseImgUrl+scope.row.url"></video>
        </template>
      </el-table-column>
        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="url" prop="url">
              <el-input v-model="form.url" placeholder="请输入视频链接" />
              <el-upload
                ref="upload"
                action=""
                :auto-upload="true"
...
<script>
import { getArticle, getArticleById, addArticle, updateArticle, delArticle } from '@/api/admin/video/videolist'
import { getAllType } from '@/api/admin/blog/articleType'
import { uploadVideo } from '@/api/admin/base'
